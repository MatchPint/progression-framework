...
topics:
  ...
  - name: "leadership"
    ...
    content:
      ...
      - level: 4
        criteria:
          - "Contributes to maintaining the MatchPint culture in their team, helping new joiners"
          - "Gets buy-in on technical decision-making and proposed designs"
          - "Proactively involves other relevant engineers"
          - "Sought out for code reviews"
          - "Instills MatchPint engineering principles in other engineers"
      ...
      - level: 5
        criteria:
          - "Instills MatchPint engineering principles across a whole squad of engineers"
          ...
          - "Contributes to maintaining the MatchPint culture in the wider company"
  ...
  - name: "influence"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Represents MatchPint at conferences/events"
          - "Given as reason for other engineers to join MatchPint"
